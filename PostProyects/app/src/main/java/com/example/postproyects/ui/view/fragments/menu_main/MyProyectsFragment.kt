...
import com.example.postproyects.databinding.MyProyectsFragmentBinding
...
@AndroidEntryPoint
class MyProyectsFragment : Fragment(), SearchView.OnQueryTextListener {
    ...
    private var _binding: MyProyectsFragmentBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = MyProyectsFragmentBinding.inflate(
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnCreatePublish.setOnClickListener {
    ...
    private fun search(){
        when (ldvm.data.value) {
            ...
            else ->{ mmvm.searchMyProyects(ldvm.data.value.toString(),status,type,"")}
        }
    }
    private fun search(name:String){
        when (ldvm.data.value) {
            "",null -> { binding.errorToken.isVisible = true}
            else ->{ mmvm.searchMyProyects(ldvm.data.value.toString(),status,type,name)}
        }
    }
